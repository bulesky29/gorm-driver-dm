...
func (DB2G db2g) charToString(bytes []byte, column *column, conn *DmConnection) string {
	...
	return Dm_build_920.Dm_build_1172(bytes, conn.serverEncoding, conn)
}
...
func (DB2G db2g) toBytes(bytes []byte, column *column, conn *DmConnection) ([]byte, error) {
	retBytes := Dm_build_920.Dm_build_1071(bytes, 0, len(bytes))
	...
	case CLOB:
		...
		return Dm_build_920.Dm_build_1136(str, conn.getServerEncoding(), conn), nil
	case BLOB:
...
func (DB2G db2g) toString(bytes []byte, column *column, conn *DmConnection) string {
	...
	case SMALLINT:
		return strconv.FormatInt(int64(Dm_build_920.Dm_build_1144(bytes)), 10)
	case INT:
		return strconv.FormatInt(int64(Dm_build_920.Dm_build_1147(bytes)), 10)
	case BIGINT:
		return strconv.FormatInt(int64(Dm_build_920.Dm_build_1150(bytes)), 10)
	case REAL:
		return strconv.FormatFloat(float64(Dm_build_920.Dm_build_1153(bytes)), 'f', -1, 32)
	case DOUBLE:
		return strconv.FormatFloat(float64(Dm_build_920.Dm_build_1156(bytes)), 'f', -1, 64)
	case DECIMAL:
...
func (DB2G db2g) toBool(bytes []byte, column *column, conn *DmConnection) (bool, error) {
	...
	case SMALLINT:
		return Dm_build_920.Dm_build_1017(bytes, 0) != 0, nil
	case INT:
		return Dm_build_920.Dm_build_1022(bytes, 0) != 0, nil
	case BIGINT:
		return Dm_build_920.Dm_build_1027(bytes, 0) != 0, nil
	case REAL:
		return Dm_build_920.Dm_build_1032(bytes, 0) != 0, nil
	case DOUBLE:
		return Dm_build_920.Dm_build_1036(bytes, 0) != 0, nil
	case DECIMAL:
...
func (DB2G db2g) toInt16(bytes []byte, column *column, conn *DmConnection) (int16, error) {
	...
	case SMALLINT:
		return Dm_build_920.Dm_build_1017(bytes, 0), nil
	case INT:
...
func (DB2G db2g) toUInt16(bytes []byte, column *column, conn *DmConnection) (uint16, error) {
	...
	case SMALLINT:
		return uint16(Dm_build_920.Dm_build_1017(bytes, 0)), nil
	case INT:
		tval := Dm_build_920.Dm_build_1022(bytes, 0)
...
func (DB2G db2g) toInt32(bytes []byte, column *column, conn *DmConnection) (int32, error) {
	...
	case SMALLINT:
		return int32(Dm_build_920.Dm_build_1017(bytes, 0)), nil
	case INT:
		return Dm_build_920.Dm_build_1022(bytes, 0), nil
	case BIGINT:
		tval := Dm_build_920.Dm_build_1027(bytes, 0)
...
func (DB2G db2g) toUInt32(bytes []byte, column *column, conn *DmConnection) (uint32, error) {
	...
	case SMALLINT:
		return uint32(Dm_build_920.Dm_build_1017(bytes, 0)), nil
	case INT:
		return uint32(Dm_build_920.Dm_build_1022(bytes, 0)), nil
	case BIGINT:
		tval := Dm_build_920.Dm_build_1027(bytes, 0)
...
func (DB2G db2g) toInt64(bytes []byte, column *column, conn *DmConnection) (int64, error) {
	...
	case SMALLINT:
		return int64(Dm_build_920.Dm_build_1144(bytes)), nil
	case INT:
		return int64(Dm_build_920.Dm_build_1147(bytes)), nil
	case BIGINT:
		return int64(Dm_build_920.Dm_build_1150(bytes)), nil
	case REAL:
		return int64(Dm_build_920.Dm_build_1153(bytes)), nil
	case DOUBLE:
		return int64(Dm_build_920.Dm_build_1156(bytes)), nil
...
func (DB2G db2g) toUInt64(bytes []byte, column *column, conn *DmConnection) (uint64, error) {
	...
	case SMALLINT:
		return uint64(Dm_build_920.Dm_build_1144(bytes)), nil
	case INT:
		return uint64(Dm_build_920.Dm_build_1147(bytes)), nil
	case BIGINT:
		return uint64(Dm_build_920.Dm_build_1150(bytes)), nil
	case REAL:
		return uint64(Dm_build_920.Dm_build_1153(bytes)), nil
	case DOUBLE:
		return uint64(Dm_build_920.Dm_build_1156(bytes)), nil
...
func (DB2G db2g) toFloat32(bytes []byte, column *column, conn *DmConnection) (float32, error) {
	...
	case SMALLINT:
		return float32(Dm_build_920.Dm_build_1017(bytes, 0)), nil
	case INT:
		return float32(Dm_build_920.Dm_build_1022(bytes, 0)), nil
	case BIGINT:
		return float32(Dm_build_920.Dm_build_1027(bytes, 0)), nil
	case REAL:
		return Dm_build_920.Dm_build_1032(bytes, 0), nil
	case DOUBLE:
		dval := Dm_build_920.Dm_build_1036(bytes, 0)
...
func (DB2G db2g) toFloat64(bytes []byte, column *column, conn *DmConnection) (float64, error) {
	...
	case SMALLINT:
		return float64(Dm_build_920.Dm_build_1017(bytes, 0)), nil
	case INT:
		return float64(Dm_build_920.Dm_build_1022(bytes, 0)), nil
	case BIGINT:
		return float64(Dm_build_920.Dm_build_1027(bytes, 0)), nil
	case REAL:
		return float64(Dm_build_920.Dm_build_1032(bytes, 0)), nil
	case DOUBLE:
		return Dm_build_920.Dm_build_1036(bytes, 0), nil
	case DECIMAL:
		dval, err := DB2G.decToDecimal(bytes, int(column.prec), int(column.scale), conn.CompatibleOracle())
		if err != nil {
			return 0, err
...
func (DB2G db2g) toDmDecimal(value []byte, column *column, conn *DmConnection) (*DmDecimal, error) {
	...
	case SMALLINT:
		return NewDecimalFromInt64(int64(Dm_build_920.Dm_build_1017(value, 0)))
	case INT:
		return NewDecimalFromInt64(int64(Dm_build_920.Dm_build_1022(value, 0)))
	case BIGINT:
		return NewDecimalFromInt64(Dm_build_920.Dm_build_1027(value, 0))
	case REAL:
		return NewDecimalFromFloat64(float64(Dm_build_920.Dm_build_1032(value, 0)))
	case DOUBLE:
		return NewDecimalFromFloat64(Dm_build_920.Dm_build_1036(value, 0))
	case DECIMAL:
...
func (DB2G db2g) toObject(bytes []byte, column *column, conn *DmConnection) (interface{}, error) {
	...
	case TINYINT:
		...
		return Dm_build_920.Dm_build_1013(bytes, 0), nil
	case SMALLINT:
		return Dm_build_920.Dm_build_1017(bytes, 0), nil
	case INT:
		return Dm_build_920.Dm_build_1022(bytes, 0), nil
	case BIGINT:
		return Dm_build_920.Dm_build_1027(bytes, 0), nil
	case DECIMAL:
